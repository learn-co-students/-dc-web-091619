...
Step 5: Just build your features

### Let's make an app from scratch
X When the page loads, I see wild pokemon's name in a card
//When Dblclick, I add pokemon to team
//When Dblclick, I remove pokemon from team
//When single click, I display Pokemon
