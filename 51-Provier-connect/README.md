...
## Goal
- connect redux to react such that a change is store/store is mapped to a change in react props
...
- Used connect() to connect the state inside store to the props inside a Component
- Use Case:
